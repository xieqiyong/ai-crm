...
CRM_AI_JWT_SECRET=${CRM_AI_JWT_SECRET:-}
CRM_AI_DATABASE_ENABLED=${CRM_AI_DATABASE_ENABLED:-true}
CRM_AI_DATABASE_URI=${CRM_AI_DATABASE_URI:-}
CRM_AI_AGENT_CONFIG_SOURCE=${CRM_AI_AGENT_CONFIG_SOURCE:-database}
CRM_AI_AGENT_CONFIG_FAIL_FAST=${CRM_AI_AGENT_CONFIG_FAIL_FAST:-false}
CRM_AI_TOKEN_DAILY_LIMIT=${CRM_AI_TOKEN_DAILY_LIMIT:-0}
CRM_AI_TOKEN_RESERVE_OUTPUT_TOKENS=${CRM_AI_TOKEN_RESERVE_OUTPUT_TOKENS:-4000}
