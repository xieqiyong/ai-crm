...
public class PermissionSeedService {
    ...
    private String[][] permissionDefinitions() {
        return new String[][] {
            ...
            {"menu.public_pool", "公海池菜单", "MENU", "public-pool"},
            ...
            {"crm:public-pool:view", "公海池查看", "ACTION", ""},
            {"crm:public-pool:assign", "公海池分配", "ACTION", ""},
            ...
            {"crm:wecom:view", "企业微信同步查看", "ACTION", ""},
            {"crm:wecom:manage", "企业微信同步配置", "ACTION", ""},
            {"crm:wecom:sync", "企业微信客户同步", "ACTION", ""},
            ...
            {"crm:task:view", "销售任务查看", "ACTION", ""},
            {"crm:task:manage", "销售任务管理", "ACTION", ""},
            {"crm:task:create", "销售任务创建", "ACTION", ""},
            {"crm:task:assign", "销售任务分配", "ACTION", ""},
            ...
            {"crm:notification:manage", "系统通知发布", "ACTION", ""},
            {"crm:mail:view", "客户邮件记录查看", "ACTION", ""},
